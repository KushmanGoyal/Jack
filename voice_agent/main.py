...
from agents import confirm_loop, dispatch
...
def main():
    ...
    while True:
        try:
            ...
            # Step 3 — Open-ended recording until end command
            ...
            # Step 3 — LLM confirmation loop
            plan = confirm_loop(text)
            if plan is None:
                log("RESPONSE", "Could not confirm a plan. Going back to sleep.")
                continue
